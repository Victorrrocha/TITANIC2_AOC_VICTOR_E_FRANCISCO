...
-- *****************************************************************************
-- Generated on "12/04/2018 18:09:53"
...
SIGNAL test_reg1 : STD_LOGIC_VECTOR(15 DOWNTO 0);
SIGNAL test_reg2 : STD_LOGIC_VECTOR(15 DOWNTO 0);
...
-- test_reg1[15]
t_prcs_test_reg1_15: PROCESS
BEGIN
	test_reg1(15) <= 'Z';
WAIT;
END PROCESS t_prcs_test_reg1_15;
-- test_reg1[14]
t_prcs_test_reg1_14: PROCESS
BEGIN
	test_reg1(14) <= 'Z';
WAIT;
END PROCESS t_prcs_test_reg1_14;
-- test_reg1[13]
t_prcs_test_reg1_13: PROCESS
BEGIN
	test_reg1(13) <= 'Z';
WAIT;
END PROCESS t_prcs_test_reg1_13;
-- test_reg1[12]
t_prcs_test_reg1_12: PROCESS
BEGIN
	test_reg1(12) <= 'Z';
WAIT;
END PROCESS t_prcs_test_reg1_12;
-- test_reg1[11]
t_prcs_test_reg1_11: PROCESS
BEGIN
	test_reg1(11) <= 'Z';
WAIT;
END PROCESS t_prcs_test_reg1_11;
-- test_reg1[10]
t_prcs_test_reg1_10: PROCESS
BEGIN
	test_reg1(10) <= 'Z';
WAIT;
END PROCESS t_prcs_test_reg1_10;
-- test_reg1[9]
t_prcs_test_reg1_9: PROCESS
BEGIN
	test_reg1(9) <= 'Z';
WAIT;
END PROCESS t_prcs_test_reg1_9;
-- test_reg1[8]
t_prcs_test_reg1_8: PROCESS
BEGIN
	test_reg1(8) <= 'Z';
WAIT;
END PROCESS t_prcs_test_reg1_8;
-- test_reg1[7]
t_prcs_test_reg1_7: PROCESS
BEGIN
	test_reg1(7) <= 'Z';
WAIT;
END PROCESS t_prcs_test_reg1_7;
-- test_reg1[6]
t_prcs_test_reg1_6: PROCESS
BEGIN
	test_reg1(6) <= 'Z';
WAIT;
END PROCESS t_prcs_test_reg1_6;
-- test_reg1[5]
t_prcs_test_reg1_5: PROCESS
BEGIN
	test_reg1(5) <= 'Z';
WAIT;
END PROCESS t_prcs_test_reg1_5;
-- test_reg1[4]
t_prcs_test_reg1_4: PROCESS
BEGIN
	test_reg1(4) <= 'Z';
WAIT;
END PROCESS t_prcs_test_reg1_4;
-- test_reg1[3]
t_prcs_test_reg1_3: PROCESS
BEGIN
	test_reg1(3) <= 'Z';
WAIT;
END PROCESS t_prcs_test_reg1_3;
-- test_reg1[2]
t_prcs_test_reg1_2: PROCESS
BEGIN
	test_reg1(2) <= 'Z';
WAIT;
END PROCESS t_prcs_test_reg1_2;
-- test_reg1[1]
t_prcs_test_reg1_1: PROCESS
BEGIN
	test_reg1(1) <= 'Z';
WAIT;
END PROCESS t_prcs_test_reg1_1;
-- test_reg1[0]
t_prcs_test_reg1_0: PROCESS
BEGIN
	test_reg1(0) <= 'Z';
WAIT;
END PROCESS t_prcs_test_reg1_0;
-- test_reg2[15]
t_prcs_test_reg2_15: PROCESS
BEGIN
	test_reg2(15) <= 'Z';
WAIT;
END PROCESS t_prcs_test_reg2_15;
-- test_reg2[14]
t_prcs_test_reg2_14: PROCESS
BEGIN
	test_reg2(14) <= 'Z';
WAIT;
END PROCESS t_prcs_test_reg2_14;
-- test_reg2[13]
t_prcs_test_reg2_13: PROCESS
BEGIN
	test_reg2(13) <= 'Z';
WAIT;
END PROCESS t_prcs_test_reg2_13;
-- test_reg2[12]
t_prcs_test_reg2_12: PROCESS
BEGIN
	test_reg2(12) <= 'Z';
WAIT;
END PROCESS t_prcs_test_reg2_12;
-- test_reg2[11]
t_prcs_test_reg2_11: PROCESS
BEGIN
	test_reg2(11) <= 'Z';
WAIT;
END PROCESS t_prcs_test_reg2_11;
-- test_reg2[10]
t_prcs_test_reg2_10: PROCESS
BEGIN
	test_reg2(10) <= 'Z';
WAIT;
END PROCESS t_prcs_test_reg2_10;
-- test_reg2[9]
t_prcs_test_reg2_9: PROCESS
BEGIN
	test_reg2(9) <= 'Z';
WAIT;
END PROCESS t_prcs_test_reg2_9;
-- test_reg2[8]
t_prcs_test_reg2_8: PROCESS
BEGIN
	test_reg2(8) <= 'Z';
WAIT;
END PROCESS t_prcs_test_reg2_8;
-- test_reg2[7]
t_prcs_test_reg2_7: PROCESS
BEGIN
	test_reg2(7) <= 'Z';
WAIT;
END PROCESS t_prcs_test_reg2_7;
-- test_reg2[6]
t_prcs_test_reg2_6: PROCESS
BEGIN
	test_reg2(6) <= 'Z';
WAIT;
END PROCESS t_prcs_test_reg2_6;
-- test_reg2[5]
t_prcs_test_reg2_5: PROCESS
BEGIN
	test_reg2(5) <= 'Z';
WAIT;
END PROCESS t_prcs_test_reg2_5;
-- test_reg2[4]
t_prcs_test_reg2_4: PROCESS
BEGIN
	test_reg2(4) <= 'Z';
WAIT;
END PROCESS t_prcs_test_reg2_4;
-- test_reg2[3]
t_prcs_test_reg2_3: PROCESS
BEGIN
	test_reg2(3) <= 'Z';
WAIT;
END PROCESS t_prcs_test_reg2_3;
-- test_reg2[2]
t_prcs_test_reg2_2: PROCESS
BEGIN
	test_reg2(2) <= 'Z';
WAIT;
END PROCESS t_prcs_test_reg2_2;
-- test_reg2[1]
t_prcs_test_reg2_1: PROCESS
BEGIN
	test_reg2(1) <= 'Z';
WAIT;
END PROCESS t_prcs_test_reg2_1;
-- test_reg2[0]
t_prcs_test_reg2_0: PROCESS
BEGIN
	test_reg2(0) <= 'Z';
WAIT;
END PROCESS t_prcs_test_reg2_0;
-- test_ula_op[7]
